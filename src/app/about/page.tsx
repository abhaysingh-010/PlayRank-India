...
[
  {
    ...
    description: "PlayRank is built around structured esports data: teams, players, matches, tournaments, rankings, official source rows and historical snapshots.",
  },
  {
    label: "Analysis Layer",
    title: "Competitive Intelligence",
    description: "We convert performance data into rank movement, player impact, team strength, match reads and comparison signals.",
  },
  {
    label: "Trust Layer",
    title: "Source Before Insight",
    description: "PlayRank separates official source data, verified records, staged imports and PlayRank-generated analytics so users understand what each claim is based on.",
  },
];
...
[
  {
    ...
    description: "PlayRank is independent. It is not affiliated with, endorsed by, or operated by Krafton, PUBG, BGMI, or tournament organizers.",
  },
  {
    label: "Attributed",
    title: "Official source data is credited",
    description: "When PlayRank uses official or external source data, it should be clearly labeled and credited wherever possible.",
  },
  {
    label: "Calculated",
    title: "Analytics are PlayRank-generated",
    description: "Rank reads, edge scores, confidence labels and comparison signals are independently calculated from available data.",
  },
  {
    label: "No Predictions",
    title: "Intelligence, not betting or guarantees",
    description: "PlayRank analytics explain current competitive context. They are not betting tips, outcome guarantees or official predictions.",
  },
];
  ...
  return (
    <article className="rounded-[2rem] border border-white/10 bg-white/[0.035] p-6">
      <div className="flex items-start justify-between gap-4">
        <p className="text-xs font-black uppercase tracking-[0.22em] text-[#ffd21a]">{item.label}</p>
        <span className="text-sm font-black text-white/25">{String(index + 1).padStart(2, "0")}</span>
      </div>
      <h3 className="mt-6 text-2xl font-black uppercase leading-tight tracking-[-0.04em] text-white">{item.title}</h3>
    ...
    <main className="min-h-screen bg-black text-white">
      <section className="krafton-grid relative min-h-[calc(100vh-82px)] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-82px)] max-w-[1600px] flex-col justify-center px-7 py-20 md:px-14">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            ...
            <Link href="/data" className="btn-secondary px-6 py-3 text-sm">Data Trust</Link>
          </div>
        </div>
      </section>
      <section className="border-y border-red-400/20 bg-red-400/[0.06] px-7 py-10 md:px-14">
        <div className="mx-auto max-w-[1600px]">
          ...
          <h2 className="mt-5 text-3xl font-black uppercase tracking-[-0.04em] text-white md:text-5xl">Independent Esports Intelligence Platform</h2>
      ...
      <section className="mx-auto max-w-[1600px] px-7 py-24 md:px-14">
        <div className="mb-8 border-b border-white/10 pb-5">
          ...
          <h2 className="mt-3 text-4xl font-black uppercase tracking-[-0.04em] text-white md:text-5xl">What PlayRank Is And Is Not</h2>
        </div>
      ...
      <section className="krafton-grid relative overflow-hidden px-7 py-24 text-center md:px-14">
        <div className="relative z-10 mx-auto max-w-5xl">
          ...
          <div className="mt-9 flex flex-wrap justify-center gap-3">
            ...
            <Link href="/data" className="btn-secondary px-6 py-3 text-sm">Review Data Trust</Link>
          </div>
        </div>
      </section>
    </main>
