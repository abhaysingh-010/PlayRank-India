        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-white/50">
              Current PlayRank team order using official and verified team
              ranking records where available. Each row shows source status,
              rank movement and latest available ranking timestamp.
            </p>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-4">
              ...
              <p className="mt-2 text-xl font-black">
                {rankedTeams.length.toLocaleString("en-IN")}
              </p>
            </div>
