...
export default function PubgImportPage() {
  return (
    <main className="bg-[#030406] text-white">
      ...
      <section className="mx-auto grid max-w-[1500px] gap-5 px-5 py-10 md:px-8 lg:grid-cols-[0.92fr_1.08fr]">
        <section className="border border-white/10 bg-[#080a0f] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.28)] md:p-6">
        ...
        <section className="space-y-5">
          <div className="border border-yellow-400/20 bg-yellow-400/10 p-5 md:p-6">
          ...
          <div className="border border-white/10 bg-[#080a0f] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.28)] md:p-6">
            <div className="mb-5 border-b border-white/10 pb-4">
              <p className="text-xs font-black uppercase tracking-[0.25em] text-[#ffd21a]">
                Workflow
              </p>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Link
              href="/admin/pubg/imports"
              className="border border-white/10 bg-white/[0.035] p-4 transition hover:border-[#ffd21a]/30 hover:bg-white/[0.055]"
            >
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#ffd21a]">
                Next
              </p>
