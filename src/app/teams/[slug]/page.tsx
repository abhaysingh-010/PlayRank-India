...
type Match = { id:string; winner_team_id:string|null; team1_score:number|null; team2_score:number|null; map_name:string|null; stage:string|null; date:string|null; team1:{name:string}|null; team2:{name:string}|null };
