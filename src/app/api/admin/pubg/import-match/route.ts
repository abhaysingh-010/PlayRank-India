...
export async function GET(request: NextRequest) 
{
    ...
    (
      {
        ...
        example:"/api/admin/pubg/import-match?shard=steam&matchId=f89445ae-489c-4992-add6-9999f644d55e",
      },
      { status: 400 }
    );
  }
  ...
  try 
  {
    ...
    const payloadObject = typeof payload === "object" && payload !== null? (payload as Record<string, any>) : null;
    ...
    const includedCount = Array.isArray(payloadObject?.included)? payloadObject.included.length: 0;
